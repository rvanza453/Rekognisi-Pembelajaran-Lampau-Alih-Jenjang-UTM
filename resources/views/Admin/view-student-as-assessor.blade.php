  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.view-assessor-students', $assessor->id) }}">Mahasiswa Assessor</a></li>
          ...
          <div class="card-body">
            ...
            <div class="tab-content pt-2" id="borderedTabContent">
              ...
              <div class="tab-pane fade" id="self-assessment" role="tabpanel" aria-labelledby="self-assessment-tab">
                  ...
                  @else
                      @php
                          // Tentukan slot nilai asesor yang sedang dilihat (assessor 1, 2, atau 3)
                          $assessorSlotName = '';
                      ...
                      <div class="accordion" id="selfAssessmentAccordion">
                          @foreach($cpmkAssessments as $nama_matkul => $assessments)
                              <div class="accordion-item">
                                  <h2 class="accordion-header" id="heading-{{ \Str::slug($nama_matkul) }}">
                                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{ \Str::slug($nama_matkul) }}" aria-expanded="false">
                                          {{ $nama_matkul }}
                                      </button>
                                  </h2>
                                  <div id="collapse-{{ \Str::slug($nama_matkul) }}" class="accordion-collapse collapse" data-bs-parent="#selfAssessmentAccordion">
...
{{-- PERBAIKAN 1: Pastikan HTML Modal memiliki tombol close (X) di header --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        {{-- Tombol 'x' ini penting dan harus ada --}}
      </div>
...
{{-- PERBAIKAN 2: Ganti keseluruhan blok @push('scripts') dengan ini --}}
@push('scripts')
<script>
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (tabButtons.length > 0) {
        tabButtons.forEach(btn => {
            btn.addEventListener('click', function(event) {
                ...
                document.querySelectorAll('.tab-pane, .tab-content').forEach(tabContent => {
    ...
    // Logika untuk MODAL
    const cpmkModalEl = document.getElementById('cpmkModal');
    const cpmkModal = new bootstrap.Modal(cpmkModalEl);
    
    const matkulNameInModal = document.getElementById('matkulNameInModal');
    const cpmkModalBody = document.getElementById('cpmkModalBody');
    ...
    document.querySelectorAll('.view-cpmk-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            // PERBAIKAN 3: Pastikan URL fetch sudah benar untuk role admin
            fetch(`/admin/matkul/${matkulId}/cpmk`) 
                .then(response => {
    ...
    // PERBAIKAN 4: Event listener manual untuk MENUTUP modal
