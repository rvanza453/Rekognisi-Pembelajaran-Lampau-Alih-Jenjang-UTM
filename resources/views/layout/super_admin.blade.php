      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-sidebar').submit();">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('super.account-super-admin-table') }}">
              <i class="bi bi-circle"></i><span>Super Admin</span>
            </a>
          </li>
          <li>
            <a href="{{ route('super.account-admin-table') }}">
              <i class="bi bi-circle"></i><span>Admin</span>
            </a>
          </li>
          <li>
            <a href="{{ route('super.account-assessor-table') }}">
              <i class="bi bi-circle"></i><span>Assessor</span>
            </a>
          </li>
          <li>
            <a href="{{ route('super.account-user-table') }}">
      ...
      <ul id="data-user-sidebar" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="{{ route('super.data-user-table') }}">
            <i class="bi bi-circle"></i><span>Mahasiswa RPL</span>
          </a>
        </li>
        <li>
          <a href="{{ route('super.data-assessor-table') }}">
            <i class="bi bi-circle"></i><span>Assessor</span>
          </a>
        </li>
      </ul>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('super.kelola-matkul-table') }}">
          <i class="bi bi-journal-text"></i><span>Mata Kuliah</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('super.kelola-assessor-mahasiswa') }}">
          <i class="bi bi-journal-text"></i><span>Penugasan Assessor</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('super.kelola-periode') }}">
