...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/assessor/dashboard" class=" d-flex align-items-center">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item me-2">
          <a class="nav-link btn btn-outline-primary btn-sm" href="https://rpl-eporto-utm.uinfaq.org/" target="_blank">
            <i class="bi bi-arrow-right-circle"></i>
            <span>Ke E-Portofolio</span>
          </a>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
            ...
            @if($totalNotifications > 0)
              <span class="badge bg-danger badge-number">{{ $totalNotifications }}</span>
            @endif
          </a>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            <li class="dropdown-header">
              @if($totalNotifications > 0)
                Anda memiliki {{ $totalNotifications }} notifikasi deadline
              @else
                Tidak ada notifikasi deadline
              @endif
              <a href="{{ route('list-name-table') }}"><span class="badge rounded-pill bg-primary p-2 ms-2">Lihat semua</span></a>
            </li>
            <li>
            ...
            @if($deadlineStats['overdue'] > 0)
              <li class="notification-item">
                ...
                <div>
                  ...
                  <p>{{ $deadlineStats['overdue'] }} penilaian telah melewati deadline</p>
            ...
            @if($deadlineStats['approaching'] > 0)
              <li class="notification-item">
                <i class="bi bi-clock text-warning"></i>
                <div>
                  <h4>Deadline Mendekati</h4>
                  <p>{{ $deadlineStats['approaching'] }} penilaian mendekati deadline</p>
                  <p>≤ 3 hari lagi</p>
                </div>
              </li>
              <li><hr class="dropdown-divider"></li>
            ...
            <li class="dropdown-footer">
              <a href="{{ route('list-name-table') }}">Lihat semua penilaian</a>
            </li>
