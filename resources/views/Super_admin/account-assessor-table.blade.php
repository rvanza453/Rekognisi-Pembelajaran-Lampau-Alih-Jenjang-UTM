        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ route('super.account-assessor-add') }}" class="btn btn-primary mb-3 float-end">Tambah</a>

              <!-- Dropdown for selecting Jurusan -->
              <form class="row g-3" action="{{ route('super.account-assessor-table') }}" method="GET">
