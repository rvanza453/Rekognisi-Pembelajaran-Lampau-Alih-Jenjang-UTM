            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('super.kelola-assessor-mahasiswa') }}" class="btn btn-primary">
                            <i class="bi bi-people"></i> Kelola Assessor Mahasiswa
                        </a>
                        <a href="{{ route('super.kelola-periode') }}" class="btn btn-success">
                            <i class="bi bi-calendar"></i> Kelola Periode
                        </a>
                        <a href="{{ route('super.kelola-matkul-table') }}" class="btn btn-info">
