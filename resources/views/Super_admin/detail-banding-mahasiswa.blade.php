          ...
          <div class="card-body">
            ...
            <div class="card mt-4">
              <div class="card-body">
                ...
                <form action="{{ route('super.proses-banding', $camaba->id) }}" method="POST">
                  @csrf
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                      ...
                      <tbody>
                        @forelse($banding_matkul as $matkul_id => $banding)
                        <tr>
                ...
                @if($ada_banding_selesai)
                  <form action="{{ route('super.publish-results-banding', $camaba->id) }}" method="POST" class="mt-3" id="publishBandingForm">
                    @csrf
