...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <div style="width: 35px; height: 35px; overflow: hidden; position: relative; border-radius: 50%;">
                <img src="<?php echo e($fotoUrlDiHeaderAdmin ?? $fotoDefaultPathAdmin); ?>" alt="Profile"
                     style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            </div>
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo e($namaUserDiHeaderAdmin); ?></span>
            </a>

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo e($namaUserDiHeaderAdmin); ?></h6>
              <span><?php echo e($detailUserDiHeaderAdmin); ?></span>
            </li>
            <li>
            ...
            <li>
              ...
              <form id="logout-form-admin-header" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?>
              </form>
            </li>
            <?php endif; ?>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo e(route('profile-view-admin')); ?>">
  ...
  </aside><?php echo $__env->yieldContent('content'); ?>
...
</html><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/layout/admin.blade.php ENDPATH**/ ?>