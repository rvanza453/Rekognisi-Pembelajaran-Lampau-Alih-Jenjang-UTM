          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($deadlineStats['total']); ?></h6>
          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($deadlineStats['overdue']); ?></h6>
          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($deadlineStats['approaching']); ?></h6>
          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($deadlineStats['active']); ?></h6>
                  <span class="text-muted small pt-2">> 3 hari lagi</span>
                </div>
              </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('super.kelola-assessor-mahasiswa')); ?>" class="btn btn-primary">
                            <i class="bi bi-people"></i> Kelola Assessor Mahasiswa
                        </a>
                        <a href="<?php echo e(route('super.kelola-periode')); ?>" class="btn btn-success">
                            <i class="bi bi-calendar"></i> Kelola Periode
                        </a>
                        <a href="<?php echo e(route('super.kelola-matkul-table')); ?>" class="btn btn-info">
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="<?php echo e(asset('assets/img/background-utm.png')); ?>" class="d-block w-100" alt="...">
...
<?php echo $__env->make('layout.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/Super_admin/dashboard.blade.php ENDPATH**/ ?>