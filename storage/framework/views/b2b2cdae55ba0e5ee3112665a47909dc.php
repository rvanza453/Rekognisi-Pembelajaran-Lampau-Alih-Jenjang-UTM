      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <div style="width: 35px; height: 35px; overflow: hidden; position: relative; border-radius: 50%;">
                <img src="<?php echo e($fotoUrlDiHeader ?? $fotoDefaultPath); ?>" alt="Profile"
                     style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            </div>
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo e($namaUserDiHeader); ?></span>
            </a>

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo e($namaUserDiHeader); ?></h6>
              <span><?php echo e($detailUserDiHeader); ?></span> 
            </li>
            <li>
...
</html><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/layout/user.blade.php ENDPATH**/ ?>