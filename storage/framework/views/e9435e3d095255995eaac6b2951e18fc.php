          ...
          <div class="card-body">
            ...
            <div class="card mt-4">
              <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.proses-banding', $camaba->id)); ?>" method="POST">
                  <?php echo csrf_field(); ?>
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        ?>
                        <?php $__empty_1 = true; $__currentLoopData = $banding_grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matkul_id => $banding): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                ...
                <?php if($ada_banding_selesai): ?>
                  <form action="<?php echo e(route('admin.publish-results-banding', $camaba->id)); ?>" method="POST" class="mt-3" id="publishBandingFormAdmin">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/Admin/detail-banding-mahasiswa.blade.php ENDPATH**/ ?>