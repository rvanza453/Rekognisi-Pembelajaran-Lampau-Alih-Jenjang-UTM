          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($allAssignments); ?></h6>
          ...
          <div class="card info-card sales-card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($completedAssignments); ?></h6>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('list-name-table')); ?>" class="btn btn-primary">
                            <i class="bi bi-list-check"></i> Daftar Penilaian
                        </a>
                        <a href="<?php echo e(route('profile-view-assessor')); ?>" class="btn btn-info">
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="<?php echo e(asset('assets/img/background-upn.jpg')); ?>" class="d-block w-100" alt="...">
...
<?php echo $__env->make('layout.assessor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/Assessor/dashboard.blade.php ENDPATH**/ ?>