            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('kelola-assessor-mahasiswa')); ?>" class="btn btn-primary">
                            <i class="bi bi-people"></i> Kelola Assessor Mahasiswa
                        </a>
                        <a href="<?php echo e(route('kelola-matkul-table')); ?>" class="btn btn-info">
                            <i class="bi bi-book"></i> Kelola Mata Kuliah
                        </a>
                        <a href="<?php echo e(route('data-user-table')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SKRIPSI\Pembuatan Sistem\Deploy Temp\rpl-lintas-jenjang.igsindonesia.org - Tumpuk saja\rpl-lintas-jenjang.igsindonesia.org - percobaan implementasi similarity - Done\resources\views/Admin/dashboard.blade.php ENDPATH**/ ?>